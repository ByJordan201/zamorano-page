                                    ...
                                    <div className="footer_elements_inner">
                                        ...
                                        <div className="footer_social">
                                            <ul className="social_list">
                                                <li className="facebook"><a id='base-icon-social' href="https://www.facebook.com/ZIELPZ" target="_blank" rel="noopener noreferrer"><i id='icon-social' className="bi bi-facebook" ></i></a></li>
                                                {/* <li className="twitter"
                                                ><a><i className="bi bi-twitter"></i></a></li> */}
                                                <li className="instagram"><a id='base-icon-social' href="https://www.instagram.com/zamorano.ingestructural/" target="_blank" rel="noopener noreferrer"><i id='icon-social' className="bi bi-instagram"></i></a></li>
