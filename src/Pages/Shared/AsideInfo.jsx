            ...
            <div className="aside_info_inner">
                ...
                <div className="social_sites">
                    <ul className="d-flex align-items-center justify-content-center">
                        <li><a id='base-icon-social' href="https://www.facebook.com/ZIELPZ" target="_blank" rel="noopener noreferrer"><i id='icon-social' className="bi bi-facebook"></i></a></li>
                        <li><a id='base-icon-social' href="https://www.instagram.com/zamorano.ingestructural/" target="_blank" rel="noopener noreferrer"><i id='icon-social' className="bi bi-instagram"></i></a></li>
                    </ul>
                </div>
            </div>
        </div >
